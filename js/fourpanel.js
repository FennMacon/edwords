$(document).ready(function() {
    ...
    $("#l4").hover(function() {
        ...
        function() {});
    $("nav").hover(function() {
            $("#response").hide().html(" <h3> What do you need to do? </h3> ").fadeIn('400');
        },
        function() {});
