$(document).ready(function() {
    $("#l1").click(function() {    
            ...
            $("#example > h2").text("Travel Gold");
            $("#example > p").text("Canada has excellent health care -- until you leave home. Then you need to buy travel health insurance, to ensure care away from home. This campaign focused on humorous \“near disasters\” to drive home the need for coverage.");
    ...
    $("#l2").click(function() {
            ...
            $("#ex").removeClass("hidden").addClass("visible");
            $("#example > h2").text("Scudder");
            $("#example > p").text("A high impact series that invested an entire year’s marketing budget in one direct mail campaign. Generated millions in business, reeled in two clients that were larger than any previous client, and won the New England Direct Marketing Association’s \“Best of Show\” award.");
    ...
    $("#l4").click(function() {
            ...
            $("#ex").removeClass("hidden").addClass("visible");
            $("#example > h2").text("WBUR");
            $("#example > p").text("One of dozens of campaigns I created for WBUR’s fundraising. During my time there, we increased the amount raised through the mail by more than TEN times. This campaign illustrated our central theme -- by contributing through the mail, you could drastically reduce on-air fundraising, a benefit that every listener would support.");
